...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.bulkInsert('items', [
      { name: 'Espresso', slug: 'espresso', price: 2.50, image: null, category_id: 1 },
      { name: 'Cappuccino', slug: 'cappuccino', price: 3.80, image: null, category_id: 1 },
      { name: 'Latte', slug: 'latte', price: 4.00, image: null, category_id: 1 },
      { name: 'Thé Earl Grey', slug: 'the-earl-grey', price: 3.00, image: null, category_id: 1 },
      { name: 'Limonade maison', slug: 'limonade-maison', price: 4.50, image: null, category_id: 2 },
      { name: 'Ice Coffee', slug: 'ice-coffee', price: 4.80, image: null, category_id: 2 },
      { name: 'Jus d\'orange', slug: 'jus-orange', price: 3.50, image: null, category_id: 2 },
      { name: 'Croissant', slug: 'croissant', price: 2.20, image: null, category_id: 3 },
      { name: 'Pain au chocolat', slug: 'pain-au-chocolat', price: 2.50, image: null, category_id: 3 },
      { name: 'Tarte aux pommes', slug: 'tarte-aux-pommes', price: 4.20, image: null, category_id: 3 },
      { name: 'Sandwich jambon', slug: 'sandwich-jambon', price: 5.50, image: null, category_id: 4 },
      { name: 'Cookie chocolat', slug: 'cookie-chocolat', price: 1.80, image: null, category_id: 4 }
    ]);
