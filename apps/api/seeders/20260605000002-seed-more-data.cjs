...
module.exports = {
  async up(queryInterface) {
    ...
    await queryInterface.bulkInsert('items', [
      ...
      { name: 'Americano',        slug: 'americano',        price: 2.80,  category_id: 1 },
      { name: 'Flat White',       slug: 'flat-white',       price: 4.20,  category_id: 1 },
      { name: 'Macchiato',        slug: 'macchiato',        price: 3.00,  category_id: 1 },
      { name: 'Chocolat chaud',   slug: 'chocolat-chaud',   price: 3.50,  category_id: 1 },
      { name: 'Thé vert',         slug: 'the-vert',         price: 3.00,  category_id: 1 },
      { name: 'Thé chai',         slug: 'the-chai',         price: 3.20,  category_id: 1 },
      { name: 'Matcha latte',     slug: 'matcha-latte',     price: 4.50,  category_id: 1 },
      { name: 'Café viennois',    slug: 'cafe-viennois',    price: 4.00,  category_id: 1 },
      // Boissons froides (cat 2)
      { name: 'Smoothie fraise',  slug: 'smoothie-fraise',  price: 5.00,  category_id: 2 },
      { name: 'Iced Matcha',      slug: 'iced-matcha',      price: 5.20,  category_id: 2 },
      { name: 'Eau pétillante',   slug: 'eau-petillante',   price: 2.00,  category_id: 2 },
      { name: 'Lemonade gingembre',slug:'lemonade-gingembre',price: 4.80, category_id: 2 },
      { name: 'Jus de pomme',     slug: 'jus-pomme',        price: 3.50,  category_id: 2 },
      { name: 'Infusion glacée',  slug: 'infusion-glacee',  price: 4.00,  category_id: 2 },
      // Pâtisseries (cat 3)
      { name: 'Madeleine',        slug: 'madeleine',        price: 1.50,  category_id: 3 },
      { name: 'Éclair café',      slug: 'eclair-cafe',      price: 3.80,  category_id: 3 },
      { name: 'Muffin myrtille',  slug: 'muffin-myrtille',  price: 2.80,  category_id: 3 },
      { name: 'Brownie',          slug: 'brownie',          price: 3.00,  category_id: 3 },
      { name: 'Cheesecake',       slug: 'cheesecake',       price: 5.50,  category_id: 3 },
      // Snacks (cat 4)
      { name: 'Sandwich poulet',  slug: 'sandwich-poulet',  price: 6.50,  category_id: 4 },
      { name: 'Wrap végétalien',  slug: 'wrap-vegetalien',  price: 6.00,  category_id: 4 },
      { name: 'Salade César',     slug: 'salade-cesar',     price: 7.50,  category_id: 4 },
      { name: 'Granola bowl',     slug: 'granola-bowl',     price: 6.80,  category_id: 4 },
      { name: 'Toast avocat',     slug: 'toast-avocat',     price: 7.00,  category_id: 4 }
    ]);
